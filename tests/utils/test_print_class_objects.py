...
import pandas as pd
from t3co.utils.print_class_objects import obj_to_string, handle_nan, custom_default, to_flat_dict, remove_df_attrs
...
def test_obj_to_string():
    ...
    obj_list = [SampleClass(attr1="value1", attr2=123), SampleClass(attr1="value2", attr2=456)]
...
def test_to_flat_dict():
    obj = SampleClass(attr1="value1", attr2=SampleClass(attr1="nested_value1", attr2=456))
    expected_output = {
        "attr1": "value1",
